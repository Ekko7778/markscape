...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/纯前端-无后端依赖-blue?style=flat-square" alt="Pure Frontend">
...
├── app.js                        # 应用逻辑
├── logo.png                      # 应用图标
├── screenshot-dark-main.png      # 深色主题主界面截图
├── screenshot-light-main.png     # 浅色主题主界面截图
├── screenshot-dark-category.png  # 深色主题分类编辑器截图
├── screenshot-light-category.png # 浅色主题分类编辑器截图
└── README.md                     # 说明文档
```
